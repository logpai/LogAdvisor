----------------------------------------------------------------------------
README file for LogAdvisor
----------------------------------------------------------------------------

Author: Jamie Zhu <jimzhu@GitHub>
Last updated: 2014/9/12.

This repository maintains the code for our project "Learning to Log", which 
is used to extract all the data instances (including the extracted features 
and logging label).
...
issue page (https://github.com/RMBLab/LogAdvisor/issues). We will help ASAP. 
...
(https://rmblab.github.io/LogAdvisor). The program is provided as-is, and there are 
